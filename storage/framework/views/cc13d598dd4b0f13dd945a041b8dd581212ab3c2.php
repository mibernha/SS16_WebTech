        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form class="form" role="form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-inline form-group" id="datum">
                       <label>Von <input type="date" class="form-control" name="start" value="<?php echo e(old('start')); ?>"></label>
                     ...
                     <label>Bis<input type="date" class="form-control" name="ende" value="<?php echo e(old('ende')); ?>"></label>
