            ...
            <div class="row">
                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/speichern')); ?>">
                    ...
                    <div class="form-group" id="straße">
                        <label for="straße" class="control-label">Strasse / HausNr.: </label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>Bitte laden Sie ihr Bodenseeschifffahrtspatent A und ihren
                            Bootsführerschein hoch:</p>
                        <div class="form-group">

                            <p>
                                <input type="file" name="Scheine" size="50" accept="text/*">
                            </p>
