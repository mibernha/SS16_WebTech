            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li><a class="page-scroll" href="<?php echo e(url('/home#index2')); ?>">Wir über uns</a></li>
                        <li><a class="page-scroll" href="<?php echo e(url('/home#buchen')); ?>">Buchen</a></li>
                        <li><a class="page-scroll" href="<?php echo e(url('/home#preis')); ?>">Preis</a></li>
                        <li><a class="page-scroll" href="<?php echo e(url('/home#anfahrt')); ?>">Anfahrt</a></li>
                        <li><a class="page-scroll" href="<?php echo e(url('/home#events')); ?>">Event</a></li>
                        <li><a class="page-scroll" href="<?php echo e(url('/home#unterkunft')); ?>">Unterkunft</a></li>
                    </ul>
