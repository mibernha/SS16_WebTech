            ...
            <button type="button" class="navbar-toggle" data-toggle="collapse"
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ol class="nav navbar-nav navbar-right">
                        ...
                        @else
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Hallo, {{ Auth::user()->vorname }}
                            <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ url('/registrieren') }}">Profil bearbeiten</a></li>
                                <li class="divider"></li>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="jumbotron" id="jumbotron2">
                <form class="form-horizontal" data-toggle="validator" role="form" method="POST" action="{{ url('/register') }}">
                        {{ csrf_field() }}
